...
class SearchVC: UIViewController {
    ...
    var tableViewRows: [customRow] = [customRow(imageValue: "person.crop.circle.badge.minus", textValue: "N.A", cellType: "Confirmed"), customRow(imageValue: "person.crop.circle.badge.checkmark", textValue: "N.A", cellType: "Recovered"), customRow(imageValue: "person.crop.circle.badge.xmark", textValue: "N.A", cellType: "Deaths")]
        ...
        NetworkManager.shared.getCountry(for: country) { [weak self] result in
            ...
            case.success(let country):
                ...
                DispatchQueue.main.async {
                    self.tableViewRows = [customRow(imageValue: "person.crop.circle.badge.minus", textValue: "\(country.confirmed.value)", cellType: "Confirmed"), customRow(imageValue: "person.crop.circle.badge.checkmark", textValue: "\(country.recovered.value)", cellType: "Recovered"), customRow(imageValue: "person.crop.circle.badge.xmark", textValue: "\(country.deaths.value)", cellType: "Deaths")]
